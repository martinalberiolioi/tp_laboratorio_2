...
namespace Navegador
{
    public partial class frmWebBrowser : Form
    {
        ...
        {
            frmHistorial aux = new frmHistorial();
            aux.ShowDialog();
        }
        ...
        { 
            ...
            Descargador down = new Descargador(new Uri(txtUrl.Text));
            Thread thr = new Thread(down.IniciarDescarga);

            down.eventoProg += new Descargador.Progreso(this.ProgresoDescarga);
            down.eventoFin += new Descargador.esFin(this.FinDescarga);
            thr.Start();
